    ...
    <div className='overflow-clip'>
      <div className="h-screen flex items-center justify-around p-10">
        <ViewTransition name="form-name">
            <div className='@container/main grow hidden lg:inline-block'>
                <span className="@3xl/main:text-[15rem] @2xl/main:text-[10rem] @xl/main:text-[8rem] text-[8rem] text-(--secondary-color) w-fit whitespace-normal">{sideText}</span>
            </div>
        </ViewTransition>
